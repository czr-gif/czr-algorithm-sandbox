...
class GPT(BaseLLM):
    ...
    def __init__(
            self, memorize: bool = False, stream_output: bool = False, model_family: str = None, model_name_override: str = None
    ) -> None:
        """
        ...
        self.api_base, self.key, self.model = "https://vip.DMXapi.com/v1","sk-bDopo5YwM7uBJW4Yqx1GeAwmJALG6Ql17o0TCiTmUS9BSHaR","gemini-3-pro-preview-thinking"
    ...
    async def _retry_request_with_sleep(self, temperature: float) -> str:
        ...
        while True:
            print(
                "Sleeping for 5 minutes before retrying request..."
            )
            ...
            try:
                ...
                print(f"Request failed in sleep mode: {e}")
    ...
    async def _ask_with_retry(self, temperature: float) -> str:
        ...
        try:
            ...
            print(f"Exceeded 5 retries, entering sleep mode: {re}")
